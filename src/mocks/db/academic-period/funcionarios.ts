...
// tabla TFUNCIONARIO con ids numéricos, que es lo que
// `resolve-director-id.ts`/la pestaña de Asignación docente necesitan. El
// mock ignora la sede (igual que `especialidades.ts` ignora el periodo) y
// devuelve el mismo catálogo para cualquier sede de prueba.
