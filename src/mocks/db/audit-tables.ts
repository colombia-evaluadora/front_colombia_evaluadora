...
export const auditTablesDb: Omit<AuditTable, "operationsToday">[] = [
  {
    slug: "tnivel_ensenanza",
    name: "tnivel_ensenanza",
    icon: "Chart-Line-Up-Icon",
    fields: getTableFields("tnivel_ensenanza"),
  },
  {
    slug: "tdepartamento",
    name: "tdepartamento",
    icon: "Map-Trifold-Icon",
    fields: getTableFields("tdepartamento"),
  },
  {
    slug: "tmunicipio",
    name: "tmunicipio",
    icon: "Bank-Icon",
    fields: getTableFields("tmunicipio"),
  },
  ...
  {
    slug: "tmodelo_pedagogico",
    name: "tmodelo_pedagógico",
    icon: "Brain-Icon",
    fields: getTableFields("tmodelo_pedagogico"),
  },
  { slug: "tjornada", name: "tjornada", icon: "Clock-Icon", fields: getTableFields("tjornada") },
  {
    slug: "tcapacidad",
    name: "tcapacidad",
    icon: "Circles-Three-Icon",
    fields: getTableFields("tcapacidad"),
  },
  {
    slug: "tpropiedad_juridica",
    name: "tpropiedad_juridica",
    icon: "Gavel-Icon",
    fields: getTableFields("tpropiedad_juridica"),
  },
  {
    slug: "tespecialidad",
    name: "tespecialidad",
    icon: "Medal-Icon",
    fields: getTableFields("tespecialidad"),
  },
  { slug: "tetnia", name: "tetnia", icon: "Users-Three-Icon", fields: getTableFields("tetnia") },
  {
    ...
    name: "tresguardo",
    icon: "Tree-Icon",
    fields: getTableFields("tresguardo"),
  },
  ...
  { slug: "tsede", name: "tsede", icon: "Address-Book-Icon", fields: getTableFields("tsede") },
  {
    ...
    fields: getTableFields("testado"),
  },
  {
    slug: "ttipo_documento",
    name: "ttipo_documento",
    icon: "IdentificationCard-Icon",
    fields: getTableFields("ttipo_documento"),
  },
  { slug: "tsexo", name: "tsexo", icon: "Gender-Intersex-Icon", fields: getTableFields("tsexo") },
  {
    ...
    fields: getTableFields("trango_edad"),
  },
  {
    slug: "tarea_conocimiento",
    name: "tarea_conocimiento",
    icon: "Book-Open-Icon",
    fields: getTableFields("tarea_conocimiento"),
  },
  {
    slug: "tasignatura",
    name: "tasignatura",
    icon: "Notebook-Icon",
    fields: getTableFields("tasignatura"),
  },
  {
    slug: "tdocente",
    name: "tdocente",
    icon: "Chalkboard-Teacher-Icon",
    fields: getTableFields("tdocente"),
  },
  {
    slug: "tevaluador",
    name: "tevaluador",
    icon: "Clipboard-Text-Icon",
    fields: getTableFields("tevaluador"),
  },
  {
    slug: "tevaluacion",
    name: "tevaluacion",
    icon: "Clipboard-Check-Icon",
    fields: getTableFields("tevaluacion"),
  },
  {
    slug: "tperiodo",
    name: "tperiodo",
    icon: "Calendar-Dots-Icon",
    fields: getTableFields("tperiodo"),
  },
  {
    slug: "tresultado",
    name: "tresultado",
    icon: "Trophy-Icon",
    fields: getTableFields("tresultado"),
  },
]
