...
import { coberturaPreMatriculaRoute } from "@/router"
...
export function usePreMatriculaFilters(): PreMatriculaFilters {
  const search = coberturaPreMatriculaRoute.useSearch()
  const navigate = coberturaPreMatriculaRoute.useNavigate()
