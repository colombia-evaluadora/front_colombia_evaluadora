...
interface ClearSelectionReservationsDialogProps {
  resetSelection: () => void
}

export function ClearSelectionReservationsDialog({
  resetSelection,
}: ClearSelectionReservationsDialogProps) {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Se deseleccionarán todas las reservas seleccionadas.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
