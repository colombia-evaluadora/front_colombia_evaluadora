...
const FILTER_PRE_MATRICULA_FORM_ID = "filter-pre-matricula-form"

// El `htmlFor` de la etiqueta necesita un id estable en el control.
const SEARCH_INPUT_ID = "pre-matricula-search"

interface SearchPreMatriculaProps {
...
export function SearchPreMatricula({
  activeFilterCount,
  filters,
  applyFilters,
  clearAllFilters,
}: SearchPreMatriculaProps) {
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col gap-2">
      <SearchQueryBar
        ...
        formId={FILTER_PRE_MATRICULA_FORM_ID}
      >
        <FilterReservationsForm
          id={FILTER_PRE_MATRICULA_FORM_ID}
