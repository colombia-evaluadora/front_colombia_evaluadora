...
import type { ExportFormat, ExportResult } from "@/features/establishment/academic-period/types/rating-scales"
...
function exportSelectedRatingScales(
  input: ExportSelectedRatingScalesInput
