              ...
              <>
                ...
                <TableCell>
                  <Input
                    ...
                    placeholder="Ingresar abreviaciÃ³n"
                ...
                <TableCell>
                  <Input
                    ...
                    placeholder="Ingresar nota mÃ¡xima"
                    type="number"
                    step="0.1"
                    min={range.min}
                    max={range.max}
                ...
                <TableCell>
                  <Input
                    ...
                    placeholder="Ingresar nota mÃ­nima"
                    type="number"
                    step="0.1"
                    min={range.min}
                    max={range.max}
