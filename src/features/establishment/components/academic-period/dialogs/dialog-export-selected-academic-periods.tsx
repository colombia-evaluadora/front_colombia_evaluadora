...
import { useExportSelectedAcademicPeriods } from "../../../api/mutations/export-selected-academic-periods"
import type { ExportFormat } from "../../../api/types/academic-period/academic-period"
...
export function ExportSelectedAcademicPeriodsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger
        render={
          <Button color="primary" aria-label={`Exportar ${count} seleccionados`} />
        }
      >
