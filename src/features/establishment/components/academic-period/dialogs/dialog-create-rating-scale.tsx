    ...
    >
      ...
      <DialogContent className="sm:max-w-4xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Elegí los niveles de enseñanza y agregá una o más escalas a la lista.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-x-4 gap-y-4 sm:grid-cols-2">
            ...
            <Field>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  value &&
                  setDraft((d) => ({ ...d, tipo: value as RatingScaleType }))
                }
              >
            ...
            <Field>
              ...
              <Input
                id="rs-icono"
                placeholder="Agregar iconografía (ej. 😄)"
                value={draft.iconografia}
                onChange={(e) =>
                  setDraft((d) => ({ ...d, iconografia: e.target.value }))
                }
              />
            </Field>
          </div>
                ...
                {drafts.length === 0 ? (
                  ...
                  drafts.map((d, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>{d.iconografia}</TableCell>
                      <TableCell>
                        <Button
                          type="button"
                          variant="ghost"
